...
def load_dataset(file_path):
    ...
    return question[:1000], gold_answer[:1000]
...
if __name__ == "__main__":
    model = load_model()
    question,gold_answer = load_dataset("datasets/nq-dev.jsonl")
    answer = testing(question,model)
    evaluation_and_save(question,answer,gold_answer,"output_nq.json",model) 